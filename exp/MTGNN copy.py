...
def evaluate(data, X, Y, model, evaluateL2, evaluateL1, batch_size):
    ...
    print("VN30 RMSE {}".format(np.sqrt(np.mean(((predict)[:, -1] - (Ytest)[:, -1])**2))))
...
parser.add_argument('--save', type=str, default='exp/save/MTGNN_multistock.pt',
...
parser.add_argument('--num_nodes',type=int,default=22,help='number of nodes/variables')
